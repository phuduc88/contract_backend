...
namespace Contract.Common.Cache
{
    public class MemoryCacheFactory
    {
        ...
        private Dictionary<string, object> _cacheList = new Dictionary<string, object>();
        ...
        private static MemoryCacheFactory _instance = new MemoryCacheFactory();
        ...
        {
            Ensure.Argument.NotNullOrEmpty(cacheName);
