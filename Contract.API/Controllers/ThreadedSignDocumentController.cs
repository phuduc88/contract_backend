...
namespace Contract.API.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("thread-sign-file")]
    public class ThreadedSignDocumentController : BaseController
    {
        #region Fields, Properties

        private static readonly Logger logger = new Logger();
        private readonly ThreadedSignDocumentBusiness business;

        #endregion // #region Fields, Properties

        #region Contructor

        public ThreadedSignDocumentController()
        {
            business = new ThreadedSignDocumentBusiness(GetBOFactory());
        }
        ...
        {
            var response = new ApiResultList<ThreadedSignDocumentInfo>();
            try
            {
        ...
        public IHttpActionResult GetDetail(int id)
        {
            ...
            var response = new ApiResult<ThreadedSignDocumentInfo>();
            try
            {
                response.Code = ResultCode.NoError;
                response.Message = MsgApiResponse.ExecuteSeccessful;
        ...
        public IHttpActionResult Create(ThreadedSignDocumentInfo productInfo)
        {
            if (productInfo == null)
            {
                return Error(ResultCode.DataInvalid, MsgApiResponse.DataInvalid);
        ...
        public IHttpActionResult Update(int id, ThreadedSignDocumentInfo productInfo)
        {
