...
namespace Contract.API.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("file-sign")]
    public class FileSignController : BaseController
    {
        #region Fields, Properties

        private static readonly Logger logger = new Logger();
        private readonly FileSignBusiness business;
        ...
        {
            business = new FileSignBusiness(GetBOFactory());
        }
        ...
        {
            var response = new ApiResultList<FileSignInfo>();
            try
            {
        ...
        public IHttpActionResult GetDetail(int id)
        {
            ...
            var response = new ApiResult<FileSignInfo>();
            try
            {
                response.Code = ResultCode.NoError;
                response.Message = MsgApiResponse.ExecuteSeccessful;
        ...
        public IHttpActionResult Create(DocumentSignInfo productInfo)
        {
            if (productInfo == null)
            {
                return Error(ResultCode.DataInvalid, MsgApiResponse.DataInvalid);
        ...
        public IHttpActionResult Update(int id, FileSignInfo productInfo)
        {
